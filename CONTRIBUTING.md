...
To start the TRAM application from the source code (after building), run the following command from the root directory:
...
The integration tests are designed to validate the end-to-end functionality of TRAM. They are not run as part of the default `npm run test` command.
...
- `packages/`: Contains the individual sub-packages of the project.
  ...
  - `core/`: The core backend logic for TRAM.
...
1.  **Start the TRAM application in development mode:**

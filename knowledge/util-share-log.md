---
name: share-log
description: Remote log sharing via mclo.gs for TRAM. Use when users need to share crash logs, startup failures, or repeated restart loop logs for remote troubleshooting.
---

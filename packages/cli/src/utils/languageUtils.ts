 ...
 * This file handles the creation and maintenance of ~/.tram/output-language.md
...
const LLM_OUTPUT_LANGUAGE_MARKER_PREFIX = 'tram:llm-output-language:';
...
/**
 * Returns the path to the LLM output language rule file (~/.tram/output-language.md).
 */
...
function parseOutputLanguageFromContent(content: string): string | null {
  // Primary: machine-readable marker (e.g., <!-- tram:llm-output-language: 中文 -->)

...
// TODO(merge-v0.15.10): upstream rewrote AuthDialog tests around the new
// provider-setup flow (TUI key-typing helpers, MAIN_ITEMS / OAUTH_ITEMS,
// itWhenTuiInputReliable, AuthDialog Custom API Key Wizard suite). TRAM
// keeps the Coding Plan + Alibaba Standard test surface that matches its
// AuthDialog.tsx. Revisit alongside the AuthDialog UI port.
...
/**
 * Ported from upstream v0.15.10 AuthDialog.test.tsx — helpers used by the
 * Coding Plan / API Key / Custom Provider TUI flow assertions. Keep these
 * in sync with upstream when refreshing the test surface.
 */

...
// TODO(merge-v0.15.10): upstream rewrote Help into a tabbed dialog
// (HelpTabs / GeneralHelp / CommandsHelp + scrolling). TRAM's previous
// inline Help command list is replaced; revisit dependent UIActionsContext
// HelpTab typings and slash command surfaces.
...
const DOCS_URL = 'https://tram-ai.github.io/docs/';
    ...
    <Box flexDirection="column">
      <Box marginBottom={1}>
        <Text color={theme.text.primary}>
          {t(
            'TRAM understands your codebase, makes edits with your permission, and executes commands right from your terminal.',
          )}
        </Text>
      </Box>

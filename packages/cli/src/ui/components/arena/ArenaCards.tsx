...
import type { ArenaDiffSummary } from "@tram-ai/tram-core";
 ...
 * Retained as a utility for upcoming layout refinements.
 */
function _pad(
  str: string,
  len: number,
 ...
 * Retained as a utility for upcoming layout refinements.
 */
function _truncate(str: string, maxLen: number): string {

...
import { DEFAULT_TOKEN_LIMIT } from "@tram-ai/tram-core";
...
export const tipRegistry: ContextualTip[] = [
  ...
  {
    id: "new-user-qwenmd",
    content: "Add a QWEN.md file to give TRAM persistent project context.",
    trigger: "startup",
  ...
  {
    id: "shell-commands",
    content: "You can run any shell commands from Tram using ! (e.g. !ls).",
    trigger: "startup",

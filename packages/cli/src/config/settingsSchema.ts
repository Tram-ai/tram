...
const SETTINGS_SCHEMA = {
  ...
  general: {
    ...
    properties: {
      autoResume: {
        ...
        default: true,
        description:
          "Automatically resume the previous session when opening in a directory with history.",
        showInDialog: true,
      },
      preferredEditor: {
        type: "string",
      ...
      desktopNotification: {
        ...
        default: true,
        description:
          "Send a desktop notification when a conversation completes or needs approval.",
        showInDialog: true,
      },
      chatRecording: {
        type: "boolean",
  ...
  model: {
    ...
    properties: {
      ...
      fallbacks: {
        ...
        default: [] as string[],
        description:
          'Ordered backup models to try when the primary request fails. Use "<authType>:<model>" to disambiguate cross-provider fallbacks.',
        showInDialog: false,
      },
      maxSessionTurns: {
        type: "number",
  ...
  tools: {
    ...
    properties: {
      ...
      serviceOutputToLLM: {
        type: "boolean",
        label: "Service Output to LLM",
        category: "General",
        requiresRestart: false,
        default: true,
        description:
          "When true (default), service tool outputs (logs, analysis) are included directly in the main LLM context. Set to false to store them as file references only, protecting the main LLM context from log noise.",
        showInDialog: false,
      },
    },
  },
    ...
    properties: {
      ...
      proxy: {
        ...
        default: undefined as
          | { mode?: ProxyMode; customUrl?: string }
          | undefined,
        ...
        properties: {
          mode: {
            ...
            description:
              "Proxy mode: system (use env vars), custom (specify URL), or off.",
            showInDialog: false,
          },
          customUrl: {
            type: "string",
            ...
            requiresRestart: true,
            default: undefined as string | undefined,
            description: 'Custom proxy URL when mode is "custom".',
            showInDialog: false,
          },
        },
      },
      ...
      arena: {
        ...
        properties: {
          worktreeBaseDir: {
            ...
            default: undefined as string | undefined,
            description:
              "Custom base directory for Arena worktrees. Defaults to ~/.tram/arena.",
            showInDialog: false,
          },
          preserveArtifacts: {
            type: "boolean",

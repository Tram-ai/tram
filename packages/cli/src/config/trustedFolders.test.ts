...
import { FatalConfigError, ideContextStore } from "@tram-ai/tram-core";
import {
  describe,
  it,
  expect,
...
describe("Trusted Folders Loading", () => {
  ...
  it("should use TRAM_CODE_TRUSTED_FOLDERS_PATH env var if set", () => {
    const customPath = "/custom/path/to/trusted_folders.json";
    process.env["TRAM_CODE_TRUSTED_FOLDERS_PATH"] = customPath;
    ...
    delete process.env["TRAM_CODE_TRUSTED_FOLDERS_PATH"];
  });

...
export default {
  ...
  "Channel name is required when not running in an interactive terminal.":
    "Channel name is required when not running in an interactive terminal.",
  "Channel initialization cancelled.": "Channel initialization cancelled.",
  "TRAM Channel Configuration": "TRAM Channel Configuration",
  Channel: "Channel",
  "Requested type": "Requested type",
  "(choose in page)": "(choose in page)",
  "Local test page": "Local test page",
  "Browser opened. Waiting for save or delete...":
    "Browser opened. Waiting for save or delete...",
  "Starting local channel config server...":
    "Starting local channel config server...",
  "Channel configuration completed.": "Channel configuration completed.",
  'Request body must contain a "config" object.':
    'Request body must contain a "config" object.',
  'Query parameter "bindingId" is required.':
    'Query parameter "bindingId" is required.',
  "Not found": "Not found",
  "Failed to start channel config server.":
    "Failed to start channel config server.",
  "Channel Type": "Channel Type",
  "Built-in or extension-provided channel adapter.":
    "Built-in or extension-provided channel adapter.",
  "Sender Policy": "Sender Policy",
  "Controls who can talk to this channel.":
    "Controls who can talk to this channel.",
  Allowlist: "Allowlist",
  Pairing: "Pairing",
  Open: "Open",
  ...
  "TCP port used by the local channel listener.":
    "TCP port used by the local channel listener.",
  "Server WebSocket URL": "Server WebSocket URL",
  "WebSocket endpoint used by the plugin example channel.":
    "WebSocket endpoint used by the plugin example channel.",
  "Override the WeChat iLink API base URL.":
    "Override the WeChat iLink API base URL.",
  "Channel-specific field: {{key}}": "Channel-specific field: {{key}}",
  "Channel name is required.": "Channel name is required.",
  "Channel config must be a JSON object.":
    "Channel config must be a JSON object.",
  "Waiting for WeChat QR code confirmation.":
    "Waiting for WeChat QR code confirmation.",
  "Unknown WeChat binding: {{bindingId}}":
    "Unknown WeChat binding: {{bindingId}}",
  ...
  "Failed to get QR code: HTTP {{status}}":
    "Failed to get QR code: HTTP {{status}}",
  "No qrcode in response": "No qrcode in response",
  Telegram: "Telegram",
  DingTalk: "DingTalk",
  WeChat: "WeChat",
  "Plugin Example": "Plugin Example",
  "TRAM Channel Config": "TRAM Channel Config",
  "Loading local config backend...": "Loading local config backend...",
  "Waiting for metadata from the CLI-side server.":
    "Waiting for metadata from the CLI-side server.",
  "Current config is invalid.": "Current config is invalid.",
  "No extra fields": "No extra fields",
  Selected: "Selected",
  "QR bind": "QR bind",
  "WeChat QR bind": "WeChat QR bind",
  "Switch the channel type to WeChat to enable QR binding and saved account controls.":
    "Switch the channel type to WeChat to enable QR binding and saved account controls.",
  "Binding status": "Binding status",
  "Open QR image": "Open QR image",
  ...
  "User ID": "User ID",
  "Saved at": "Saved at",
  "Start QR binding": "Start QR binding",
  ...
  "Start QR Bind": "Start QR Bind",
  "Clear Saved Login": "Clear Saved Login",
  ...
  "WeChat QR Binding": "WeChat QR Binding",
  "WeChat login is stored separately from the channel config, matching the existing CLI login behavior.":
    "WeChat login is stored separately from the channel config, matching the existing CLI login behavior.",
  "Available Channel Types": "Available Channel Types",
  "Returned by the local metadata API.": "Returned by the local metadata API.",
  "Current Raw Config": "Current Raw Config",
  "What is currently stored for this channel in user settings.":
    "What is currently stored for this channel in user settings.",
  "Saving channel config...": "Saving channel config...",
  ...
  "Channel deleted. The CLI session will close automatically.":
    "Channel deleted. The CLI session will close automatically.",
  "Requesting WeChat QR code...": "Requesting WeChat QR code...",
  "QR code requested. Waiting for scan result...":
    "QR code requested. Waiting for scan result...",
  "Saved WeChat login cleared.": "Saved WeChat login cleared.",
  "WeChat account connected successfully.":
    "WeChat account connected successfully.",

...
import { parseInsightMessage } from "@tram-ai/tram-core";
...
export class WebViewProvider {
  ...
  // TODO(merge-v0.15.10): Verify handleAuthInteractive's writeCodingPlanConfig /
  // writeModelProvidersConfig imports resolve in the TRAM codebase; this method
  // was added by upstream v0.15.10 for interactive provider configuration.

 ...
 */
export class TramSessionUpdateHandler {
  private callbacks: TramAgentCallbacks;

  constructor(callbacks: TramAgentCallbacks) {
   ...
   */
  updateCallbacks(callbacks: TramAgentCallbacks): void {
    this.callbacks = callbacks;
  }

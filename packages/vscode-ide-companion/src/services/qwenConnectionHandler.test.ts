...
import { TramConnectionHandler } from "./tramConnectionHandler.js";
import type { AcpConnection } from "./acpConnection.js";

describe("TramConnectionHandler", () => {
  let handler: TramConnectionHandler;
  ...
  beforeEach(async () => {
    ...
    handler = new TramConnectionHandler();
    mockConnection = {

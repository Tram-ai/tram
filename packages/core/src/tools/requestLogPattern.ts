...
class RequestLogPatternToolInvocation extends BaseToolInvocation<
  ...
  ToolResult
> {
  constructor(params: RequestLogPatternParams) {
    super(params);
  }
  ...
  async execute(_signal: AbortSignal): Promise<ToolResult> {
    try {
      ...
      const suggestedPatternText = this.params.suggestedPattern
      ...
      debugLogger.error(`[RequestLogPatternTool] Error: ${errorMessage}`);

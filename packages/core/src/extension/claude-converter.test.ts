...
describe("convertClaudeToTramConfig", () => {
  it("should convert basic Claude config", () => {
    ...
    const result = convertClaudeToTramConfig(claudeConfig);
  ...
  it("should throw error for missing name", () => {
    ...
    expect(() => convertClaudeToTramConfig(invalidConfig)).toThrow();
  });
});
...
describe("convertClaudePluginPackage", () => {
  ...
  it("should successfully convert agent files with Windows CRLF endings", async () => {
    ...
    // Verify: agent file was properly parsed and converted into .tram/agents folder structure
...
describe("performVariableReplacement for Claude extensions", () => {
  ...
  it("should replace .claude with .tram in shell scripts", () => {
    ...
    expect(result).toContain("$HOME/.tram/config");

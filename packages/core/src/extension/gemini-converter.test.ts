...
describe('convertGeminiToTramConfig', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should convert basic Gemini config from directory', () => {
    ...
    const result = convertGeminiToTramConfig(mockDir);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertGeminiToTramConfig(mockDir)).toThrow(

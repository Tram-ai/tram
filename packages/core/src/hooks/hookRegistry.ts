...
export class HookRegistry {
  ...
  // TODO(merge-v0.15.10): checkProjectHooksTrust() was a TRAM-specific hook trust
  // warning that no caller currently invokes. Removed for noUnusedLocals; restore
  // when wiring the warning back into config bootstrap.

...
export const EVENT_CONTENT_RETRY_FAILURE = "tram.chat.content_retry_failure";
export const EVENT_CONVERSATION_FINISHED = "tram.conversation_finished";
export const EVENT_MALFORMED_JSON_RESPONSE = "tram.malformed_json_response";
...
export const EVENT_PROMPT_SUGGESTION = "tram.prompt_suggestion";
export const EVENT_SPECULATION = "tram.speculation";

// Arena Events
export const EVENT_ARENA_SESSION_STARTED = "tram.arena_session_started";
export const EVENT_ARENA_AGENT_COMPLETED = "tram.arena_agent_completed";
export const EVENT_ARENA_SESSION_ENDED = "tram.arena_session_ended";

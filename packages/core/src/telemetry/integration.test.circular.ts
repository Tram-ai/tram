...
import type { RumEvent } from './tram-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in tram logging', () => {
    ...
    // Test that TramLogger can handle this

...
describe("isUnattendedMode", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env["TRAM_CODE_UNATTENDED_RETRY"];
  });
  ...
  it("should return true when TRAM_CODE_UNATTENDED_RETRY=1", () => {
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "1";
    expect(isUnattendedMode()).toBe(true);
  });

  it("should return true when TRAM_CODE_UNATTENDED_RETRY=true", () => {
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "true";
    expect(isUnattendedMode()).toBe(true);
  });
  ...
  it("should return false for non-matching values", () => {
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "0";
    expect(isUnattendedMode()).toBe(false);
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "false";
    expect(isUnattendedMode()).toBe(false);
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "";
    expect(isUnattendedMode()).toBe(false);
  });
  ...
  it("should use strict matching consistent with parseBooleanEnvFlag", () => {
    ...
    process.env["TRAM_CODE_UNATTENDED_RETRY"] = "yes";
    expect(isUnattendedMode()).toBe(false);
  });
});

...
<dependency>
    ...
    <artifactId>tramcode-sdk</artifactId>
...
```gradle
implementation 'com.alibaba:tramcode-sdk:{$version}'
```
...
The simplest way to use the SDK is through the `TramCodeCli.simpleQuery()` method:
...
public static void runTransportOptionsExample() {
    ...
    List<String> result = TramCodeCli.simpleQuery("who are you, what are your capabilities?", options);
    result.forEach(logger::info);
}
```
...
public static void runStreamingExample() {
    TramCodeCli.simpleQuery("who are you, what are your capabilities?",

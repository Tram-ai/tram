...
import com.alibaba.tram.code.cli.protocol.data.AssistantUsage;
import com.alibaba.tram.code.cli.protocol.data.AssistantContent;
import com.alibaba.tram.code.cli.protocol.data.AssistantContent.TextAssistantContent;
import com.alibaba.tram.code.cli.protocol.data.AssistantContent.ThingkingAssistantContent;
import com.alibaba.tram.code.cli.protocol.data.AssistantContent.ToolResultAssistantContent;
import com.alibaba.tram.code.cli.protocol.data.AssistantContent.ToolUseAssistantContent;
import com.alibaba.tram.code.cli.protocol.data.behavior.Behavior.Operation;
import com.alibaba.tram.code.cli.session.Session;
import com.alibaba.tram.code.cli.session.event.consumers.AssistantContentConsumers;
import com.alibaba.tram.code.cli.session.event.consumers.AssistantContentSimpleConsumers;
import com.alibaba.tram.code.cli.session.event.consumers.SessionEventSimpleConsumers;
import com.alibaba.tram.code.cli.transport.Transport;
import com.alibaba.tram.code.cli.transport.TransportOptions;
import com.alibaba.tram.code.cli.transport.process.ProcessTransport;
import com.alibaba.tram.code.cli.utils.MyConcurrentUtils;
import com.alibaba.tram.code.cli.utils.Timeout;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Main entry point for interacting with the TRAM CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class TramCodeCli {
    private static final Logger log = LoggerFactory.getLogger(TramCodeCli.class);

    /**
     * Sends a simple query to the TRAM CLI and returns a list of responses.
     *

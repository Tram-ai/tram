...
> JetBrains IDEs provide native support for AI coding assistants through the Agent Client Protocol (ACP). This integration allows you to use TRAM directly within your JetBrains IDE with real-time code suggestions.
...
3. Click **Add ACP Agent**, then click **Install**.
   ...
   For users using JetBrains AI Assistant and/or other ACP agents, click **Install From ACP Registry** in Agents List, then install TRAM ACP.

   ![Add from Agents List](https://img.alicdn.com/imgextra/i2/O1CN01ZyOugP26BOKzNgZXx_!!6000000007623-2-tps-479-523.png)

4. The TRAM agent should now be available in the AI Assistant panel.

   ![TRAM in JetBrains AI Chat](https://img.alicdn.com/imgextra/i4/O1CN013kAVE41XVzbIZOxyv_!!6000000002930-2-tps-3188-2170.png)
...
3. Click the 3-dot menu in the upper-right corner and select **Configure ACP Agent** and configure TRAM with the following settings:
...
![TRAM in JetBrains AI Chat](https://img.alicdn.com/imgextra/i3/O1CN01ZxYel21y433Ci6eg0_!!6000000006524-2-tps-2774-1494.png)

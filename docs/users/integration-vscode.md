...
> The VS Code extension (Beta) lets you see Qwen's changes in real-time through a native graphical interface integrated directly into your IDE, making it easier to access and interact with TRAM.
...
- **Native IDE experience**: Dedicated TRAM sidebar panel accessed via the Qwen icon
...
- **Multiple sessions**: Run multiple TRAM sessions simultaneously
